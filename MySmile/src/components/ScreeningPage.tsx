        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-[3rem] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] relative">
              <img 
                src="https://storage.googleapis.com/dala-prod-public-storage/generated-images/198a412c-5f1a-44f1-9c5f-98b3c91230ca/screening-background-d99ce5f7-1773998620760.webp" 

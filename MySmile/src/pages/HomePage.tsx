      ...
      <section id="services" className="py-32 container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="bg-white p-12 rounded-[2.5rem] shadow-sm border border-stone-100 hover:shadow-2xl transition-all duration-700 group">
            ...
            <div className="h-px w-10 bg-stone-100 group-hover:w-full transition-all duration-700 mb-8" />
            <Button 
              variant="ghost" 
              className="p-0 hover:bg-transparent text-stone-900 font-black flex items-center gap-4 uppercase text-[10px] tracking-[0.2em] group/btn"
            >
              <span className="border-b border-transparent group-hover/btn:border-stone-900 transition-all">Discover</span>
              <div className="p-2 rounded-full border border-stone-100 group-hover/btn:bg-stone-900 group-hover/btn:text-white transition-all">
                <ArrowRight size={14} />
              </div>
            </Button>
          </div>
